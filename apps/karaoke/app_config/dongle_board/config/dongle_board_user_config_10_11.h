 ...
 ***************************************************************************/
#define PRODUCT_MODEL                       "dongle_board"

#define SL_VER4_BOARD                       0
#define MYME_M4_BOARD                       0
#define EVB_RX_DEMO                         0
#define EVB_LCD_DEMO                        0
 ...
 ***************************************************************************/
/* volume config */
#define VOLUME_STEP                         10       //加减音量的步进大小
#define VOLUME_DEFAULT                      50     //默认音量
...
#define AUDIO_MIC_AENC                      0       //MIC AENC降噪
#define AUDIO_MIC_NSBWE_AENC                0       //MIC NSBWE降噪  
#define AUDIO_MIC_FREQ_SHIFT                0       //MIC 移频功能
#define AUDIO_MIC_VOCALENHANCE              0       //MIC人声增强
#define AUDIO_DONGLE_BOARD_I2S_AFC          0      //通过I2S做AFC
#define AUDIO_EFFECT_FDNREV_STEREO          1       //使用立体声混响
#define AUDIO_MIC_AFC                       0//0       //MIC通路AFC功能
...
#define LC3_ENC_CH                          2
#define LC3_DEC_CH                          1
#define AUDIO_G24_TX_ENCODER_DISABLE        0
#define AUDIO_G24_RX_DECODER_DISABLE        0//1//0
#define AUDIO_G24_TX_ENCODER_NUM            1//1//2
...
#define BT_NAME_DEFAULT                     "dongle"                          //蓝牙设备默认名字

//当BT_RFPOWER_FORCE_EN为1时，无论BT_MAXPOWER_SET_EN设置与否，均不起作用
#define BT_RFPOWER_FORCE_EN                 1       //RF发送功率固定，底层已经固定使用SBT方式连接，需要固定使用BT_RFPOWER_FORCE
...
#define G24_FUNC_ROLE                       1       //固定为1, 表示dongle
#define G24_DEVICE_ROLE                     1//0       //0:slaver,1:master
...
#define G24_RECONNECT_RSSI_THRS             0//128     //2.4G连接距离限制，范围:0-138，值越大距离越近
#define G24_MASTER_RECONNECT_NO_RSSI        1       //master非正常断线回连距离不受限，时间与回连时间一致
#define G24_SLAVER_RECONNECT_NO_RSSI_TIME   60      //salver非正常断线回连距离不受限时间，单位：秒，0表示一直受限制
#define G24_MASTER_RECONNECT_TIME           60      //master回连时间，单位：秒
#define G24_MASTER_RECONNECT_ALWAYS         1       //master一直回连，用于handset做master时且连接同一设备
#define G24_MASTER_INQUIRY_TIMES            0xFF    //master断开后新设备查询次数，时间为 5*次数 秒
#define G24_MASTER_PAGE_TIMES               1       //master断开后新设备连接次数，时间为 5*次数 秒
...
#define G24_RF_JUMP_EN                      0       //信号差时是否进行频段跳转
...
//start=================
/*总功能由宏G24_2T4_SHORT_PACKET_3TIMES(二拖四主副)和宏G24_2T4_WITH_MONO_MONITOR（一拖多）控制，
dongle端由宏G24_2T4_DONGLE_MCHIP控制主副，G24_1TN_DONGLE_MCHIP控制副芯片2t4/1tn。

主芯片
G24_2T4_SHORT_PACKET_3TIMES		1
G24_2T4_WITH_MONO_MONITOR		0
G24_2T4_DONGLE_MCHIP			1
G24_1TN_DONGLE_MCHIP			1
副芯片二拖四
G24_2T4_SHORT_PACKET_3TIMES		1
G24_2T4_WITH_MONO_MONITOR		0
G24_2T4_DONGLE_MCHIP			0
G24_1TN_DONGLE_MCHIP			0
副芯片一拖多芯片
G24_2T4_SHORT_PACKET_3TIMES		0
G24_2T4_WITH_MONO_MONITOR		1
G24_2T4_DONGLE_MCHIP			0
G24_1TN_DONGLE_MCHIP			1
...
#define G24_2T4_SHORT_PACKET_3TIMES         0//1       //一拖二短包应用于二拖四（RX 2个dongle芯片与4个handset通信）
#define G24_2T4_WITH_MONO_MONITOR			0//0

#define G24_2T4_HANDSET_SAME_FW             1           //handset使用同一个固件, 在连接阶段分配频段。只能用在主副芯片同一个RF表格，如果主芯片跑2.3G，副芯片跑2.5G则不能用
#define G24_2T4_DONGLE_MCHIP                0//1       //dongle 二拖四主副芯片选择，1：主，0：副
#define G24_1TN_DONGLE_MCHIP				0//1		//需要做三端同步，+1tn_dongle时，主芯片和1tn芯片都固定打开

#define G24_2T4_TRIG_OUTPUT_PIN_NUM         (PIN_B2)//(PIN_D8)  //触发输出引脚
#define G24_2T4_TRIG_INPUT_PIN_NUM          (PIN_B4)//(PIN_D10) //触发输入引脚
#define G24_2T4_POWER_PIN_NUM               (PIN_B1)//(PIN_D2)

#if	G24_1TN_DONGLE_MCHIP
#define G24_1TN_TRIG_OUTPUT_PIN_NUM         (PIN_B10)	  //触发输出引脚
#define G24_1TN_TRIG_INPUT_PIN_NUM          (PIN_B11)	  //触发输入引脚
#endif

#if G24_2T4_DONGLE_MCHIP
#define G24_2T4_POWER_ON()                  HAL_gpio_config(G24_2T4_POWER_PIN_NUM | PIN_FUNCOUTPUT | PIN_DRI1 | PIN_HIGH)
#define G24_2T4_POWER_OFF()                 HAL_gpio_config(G24_2T4_POWER_PIN_NUM | PIN_FUNCOUTPUT | PIN_DRI1 | PIN_LOW)
#else
#define G24_2T4_POWER_ON()
#define G24_2T4_POWER_OFF()
#endif

//end===================

#define G24_MONITOR_EN                      1//1//0       //dongle到handset单向一拖多监听功能
#define G24_MONITOR_MASTER_EN               0       //固定为0
#define G24_MONITOR_ONLINE_DETECT           0       //检测是否handset在线,没有主MIC的时候才会起作用
#define G24_MONITOR_NO_HANDSHAKE            1       //监听无握手连接，master单向发送连接信息，slaver收到即可建立连接
#define G24_MONITOR_NONE_CONTINUE           1       //master在无握手连接时，不接收slaver信息
#define G24_MONITOR_MASTER_DISCON_TIME      10      //单位秒，没有收到主MIC信号的超时时间，超时时间一到让出通道让其他主MIC有机会接入
#define G24_MONITOR_AUDIO_CH                2//1//2       //一拖多传输音频声道数，单声道会增加传输次数

#if G24_2T4_SHORT_PACKET_3TIMES 
#undef	AUDIO_G24_RX_DECODER_DISABLE
#undef	AUDIO_G24_TX_ENCODER_NUM
...
#define AUDIO_G24_TX_ENCODER_NUM            2	
#define G24_DEVICE_ROLE                     0       //0:slaver,1:master
#define G24_DUAL_CHANNEL                    1       //2.4G 1个dongle对2个handset
#define G24_MONITOR_EN                      0       //dongle到handset单向一拖多监听功能
#define G24_MONITOR_AUDIO_CH                2       //一拖多传输音频声道数，单声道会增加传输次数
#endif

//#if !G24_2T4_DONGLE_MCHIP//test
//#undef AUDIO_KARAOKE_LINEIN_EN
//#define AUDIO_KARAOKE_LINEIN_EN             0
//#endif
...
#undef G24_MONITOR_EN
#define G24_DEVICE_ROLE                     1       //一拖二时dongle固定做master
...
#define AUDIO_G24_TX_ENCODER_DISABLE        1       //长包不能发送音频数据
...
#undef AUDIO_MIC_AENC
#undef AUDIO_MIC_NSBWE_AENC                
#undef AUDIO_PLAYBACK_VSS
#define AUDIO_MIC_AENC                      0
#define AUDIO_PLAYBACK_VSS                  0
#define AUDIO_MIC_NSBWE_AENC                0

#else   //一拖一

#if G24_MONITOR_EN
#undef G24_DEVICE_ROLE
#define G24_DEVICE_ROLE                     1       //0:slaver,1:master, 监听方案固定handset做slaver，dongle做master
#endif
...
#if 0//G24_DEVICE_ROLE
#undef G24_MASTER_RECONNECT_ALWAYS
#define G24_MASTER_RECONNECT_ALWAYS         0       //dongle做master时，不一直回连，避免新slaver无法连接
#endif
...
#define RECORD_FUNC_EN                      0       //录音功能

/***************************************************************************
 *               record config
 ***************************************************************************/
#define RECORD_G24_FUNC                     1        //2.4G无线传输过来的数据
...
#define RECORD_NEW_DEVICE_FIRST             0        //0:不自动切换最新插入的设备； 1:自动切换最新插入的设备
#define RECORD_AUTO_PLAY                    0        //0:不自动播放录音文件； 1:自动播放录音文件
#define RECORD_PLAY_LOOP                    1        //0:全部循环播放; 1:单曲循环播放
#define RECORD_FORMAT_SEL                   0        //录音编码格式： 0:adpcm; 1:mp2; 2:sbc 3:pcm
...
#define I2S0_SLAVER_PLAY_EN                 1       //I2S从机播放

#if !I2S0_EN
#undef AUDIO_DONGLE_BOARD_I2S_AFC
#define AUDIO_DONGLE_BOARD_I2S_AFC          0
#endif
...
#define LCDC_IM1_PIN_NUM                    (PIN_B4)
#define LCDC_IM2_PIN_NUM                    (PIN_B30)
#define LCD_RESET_PIN_NUM                   (PIN_B2)//(PIN_B0)
#define LCD_BACKLIGHT_PIN_NUM               (PIN_D10)//(PIN_D15)   //PIN_D15 for fgpa
...
#define LCDC_X12_SEL                        0           //0:DIS;1:PD12(fpga);2:PB2;3:PD7
#define LCDC_X13_SEL                        0           //0:DIS;1:PD13(fpga);2:PB1;3:PD8
#define LCDC_X14_SEL                        0           //0:DIS;1:PD14(fpga);2:PB0;3:PD9
#define LCDC_X15_SEL                        0           //0:DIS;1:PD15(fpga);2:PD10
...
#define LCDC_X6_MAP                         0x0     //CSX       (sel PD1) 
#define LCDC_X7_MAP                         0xC     //SCL       (sel PD2)
#define LCDC_X8_MAP                         0xD     //SDA0      (sel PD3)
#define LCDC_X9_MAP                         0xF     //Disable
#define LCDC_X10_MAP                        0xF     //Disable
#define LCDC_X11_MAP                        0xF     //Disable
#define LCDC_X12_MAP                        0xF     //Disable
#define LCDC_X13_MAP                        0xF     //Disable
#define LCDC_X14_MAP                        0xF     //Disable
#define LCDC_X15_MAP                        0xF     //Disable

#if !LCDC_SPI_LINE_SEL                      //4 line
#undef LCDC_X9_MAP
#define LCDC_X9_MAP                         0x1     //DCX       (sel PD4)
#endif
...
#undef WATCHDOG_EN
#define WATCHDOG_EN                 0               //副芯片不使用看门狗复位，同一由主芯片控制，避免TX不同步
#endif

/***************************************************************************
 *               cpu freq config
 ***************************************************************************/
#define OVER_FREQ_EN                        1       //CPU频率超过192M时，需要使能超频功能，12M步进，最大不要超过288M

#define DVFS_AMIXER_FREQ                    {288000000, 288000000}//{252000000, 252000000}//{38400000, 38400000}
...
#define DVFS_SCOADMAENC_FREQ                {64000000, 96000000}
#define DVFS_USBAUDIO_FREQ                  {192000000, 192000000}
#define DVFS_LINEINAUDIO_FREQ               {64000000, 64000000}
#define DVFS_LOCAL_ENCODE_WAV_FREQ          {64000000, 64000000}
#define DVFS_LOCAL_ENCODE_MP3_FREQ          {64000000, 64000000}
#define DVFS_LOCAL_DECODE_WAV_FREQ          {64000000, 64000000}
#define DVFS_LOCAL_DECODE_MP3_FREQ          {64000000, 64000000}
...
#define VF_TABLE_5                          {288000000, 1140}//{252000000, 1140}//{192000000, 1050}
#else
 ...
 *               system config
 ***************************************************************************/
 #if MODE_BT_EN && MODE_G24_EN
#define SYS_HEAP_SIZE                      ((size_t) ((297)*1024))
#define AUDIO_HEAP_SIZE_TURNING            (243)
#else
#define SYS_HEAP_SIZE                      ((size_t) ((300 +20)*1024))
#define AUDIO_HEAP_SIZE_TURNING            (246 + 20)
...
#if MYME_G63PRO
#undef AUDIO_AMIC2_SINGLE_END
#define AUDIO_AMIC2_SINGLE_END              2  //MICIN2
#endif
...
#define REVERB_DISP_PIN_NUM                   (PIN_B2)
#define REVERB_DISP_ON()                      HAL_gpio_pull_set(REVERB_DISP_PIN_NUM, PIN_PULL_UP2K);\
                                              HAL_gpio_func_set(REVERB_DISP_PIN_NUM, PIN_FUNCINPUT)
#define REVERB_DISP_OFF()                     HAL_gpio_config(REVERB_DISP_PIN_NUM | PIN_FUNCDISABLE)

#endif


#if  AUDIO_MIC_AFC  //自动设置一些关键配置
...
#undef LC3_ENC_CH
#undef LC3_DEC_CH
#undef AUDIO_EFFECT_FDNREV_STEREO
#undef AUDIO_KARAOKE_MIC_EN


#define AUDIO_G24_TX_ENCODER_DISABLE        1		//0 -> 1	因为dongle不支持发送
#define AUDIO_G24_TX_ENCODER_NUM            1		//2 -> 1	编码器减少1个
#define G24_DUAL_CHANNEL                    0		//1拖1
#define LC3_ENC_CH                          1		//LC3单声道编码
#define LC3_DEC_CH                          1		//LC3单声道解码
#define AUDIO_EFFECT_FDNREV_STEREO			0		//立体声混响关闭
#define AUDIO_KARAOKE_MIC_EN                0		//关闭dongle本地MIC
