...
LDACBT_API int ldacBT_frame_samples_get(HANDLE_LDAC_BT hLdacBT);
LDACBT_API int ldacBT_config_decode_ch_mask( HANDLE_LDAC_BT hLdacBT, int ch_mask);
LDACBT_API int ldacBT_1ch_stream_get( HANDLE_LDAC_BT hLdacBT,char *stream_out, int *p_bytes, int *p_frmlen);
