 ...
 * if (rv != PSM_SUCCESS) {
 *	psmprintf("Variable write failed");
 *	return rv;
 * }
 *
 * char read_value[10];
 ...
 * if (rv != PSM_SUCCESS) {
 *	psmprintf("Variable read failed");
 *	return rv;
 * }
 *
 * \endcode
 ...
 */
/*
 *  Copyright 2018-2028 Shenju Technology co, Ltd.
 *  All Rights Reserved.
 */
...
#ifdef __cplusplus
#define PSM_API extern "C" __declspec(dllexport) //__declspec(dllexport)
#else
#ifdef __linux__
#define PSM_API extern __declspec(dllexport) // __declspec(dllimport)
#else
#define PSM_API
#endif
#endif
...
//#define CONFIG_PSM_DOUBLE_CHECK
 ...
 *
 * @return PSM_SUCCESS Init success.
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_E_NOMEM Memory allocation failure.
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_module_init(flash_desc_t *fdesc,
 ...
 *         For write mode: If open is successful PSM_SUCCESS is returned.
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_E_NOMEM Memory allocation failure.
 * @return -PSM_E_NOSPC If enough space is unavailable for the new
 * object. This error can only be returned in write mode.
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_object_open(psm_hnd_t phandle, const char *name,
 ...
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_E_CRC If CRC check failed.
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_object_read(psm_object_handle_t ohandle, void *buf, uint32_t max_len);
 ...
 *
 * @return PSM_SUCCESS Data was written successfully.
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_E_PERM If object was opened in read mode.
 * @return -PSM_E_NOSPC If caller tries to write more data than specified in
 * call to psm_object_open().
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_object_write(psm_object_handle_t ohandle,
 ...
 * psm_object_open()
 *
 * @return PSM_SUCCESS Object was closed successfully.
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_object_close(psm_object_handle_t *ohandle);
 ...
 * the PSM.
 *
 * @return PSM_SUCCESS Object was deleted successfully.
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_E_NOSPC If caller tries to write more data than specified in
 * call to psm_object_open().
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_object_delete(psm_hnd_t phandle, const char *name);
 ...
 * psm_module_init()
 *
 * @return PSM_SUCCESS Format operation was successful.
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_format(psm_hnd_t phandle);
 ...
 * PSM_SUCCESS, whichever comes first.
 */
 ...
 *
 * @return PSM_SUCCESS Variable-value pair was set successfully.
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_set_variable(psm_hnd_t phandle, const char *variable,
...
// simon: just make the code compile
#if 0
/**
 ...
 * returned.
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_E_NOSPC If variable value exceeds buffer length given.
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_get_variable(psm_hnd_t phandle, const char *variable,
 ...
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_FAIL if object not found or any error occurred.
 */
 ...
 *
 * @return PSM_SUCCESS if retrieval was successful
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_FAIL If any other error occurs.
 */
 ...
 * psm_module_init()
 *
 * @return PSM_SUCCESS Module de-init success.
 * @return -PSM_E_INVAL Invalid arguments.
 * @return -PSM_FAIL If any other error occurs.
 */
PSM_API int psm_module_deinit(psm_hnd_t *phandle);
